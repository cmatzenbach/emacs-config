...
;; Note:
;; This file was modified by Jeff Tecca on 2017-05-26 to work in a
;; non-spacemacs environment.  The file was taken directly from spacemacs and
;; modified only to make it run without any of the spacemacs code.  I commented
;; out the (require 'bind-map) and the call to `bind-map' that modified the
